  ...
  return (
    <div className="w-96 mx-auto mt-24">
      ...
      <form className="flex flex-col">
        ...
        <Input type="password" ref={passwordRef} placeholder="비밀번호" className="mb-6" onChange={setPassword} />
        <Input type="password" ref={passwordRef} placeholder="비밀번호 확인" className="mb-12" onChange={setPassword} />
